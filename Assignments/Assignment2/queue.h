...
public:
    ...
    /**
       Insert a new element at the specified position in the queue.

       \pre position must be less than or equal to the number of
       elements in the queue.

       \post The new element is inserted at the specified position.
     */
